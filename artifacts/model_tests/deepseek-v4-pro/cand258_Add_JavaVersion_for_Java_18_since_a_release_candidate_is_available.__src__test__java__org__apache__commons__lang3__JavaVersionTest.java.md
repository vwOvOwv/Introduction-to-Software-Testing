...
- finish_reason: `stop`
- usage: `{'prompt_tokens': 1602, 'completion_tokens': 2089, 'total_tokens': 3691, 'prompt_tokens_details': {'cached_tokens': 384}, 'completion_tokens_details': {'reasoning_tokens': 1544}, 'prompt_cache_hit_tokens': 384, 'prompt_cache_miss_tokens': 1218}`

---

- 修改 `testGetJavaVersion` 方法：增加 `assertEquals(JAVA_18, get("18"), "18 failed")`，并将原有的 `assertEquals(JAVA_RECENT, get("18"), "Unhandled")` 改为 `assertEquals(JAVA_RECENT, get("19"), "Unhandled")`。
- 新增 `import static org.apache.commons.lang3.JavaVersion.JAVA_18`。
