...
- finish_reason: `stop`
- usage: `{'prompt_tokens': 22599, 'completion_tokens': 2868, 'total_tokens': 25467, 'prompt_tokens_details': {'cached_tokens': 384}, 'completion_tokens_details': {'reasoning_tokens': 2353}, 'prompt_cache_hit_tokens': 384, 'prompt_cache_miss_tokens': 22215}`

---

- 新增 `testTruncateMiddle` 测试方法，对应生产代码中新增的 `StringUtils.truncateMiddle` 方法。
- 无需调整 import，测试类已位于同一包内。
