...
- finish_reason: `stop`
- usage: `{'prompt_tokens': 2822, 'completion_tokens': 384, 'total_tokens': 3206, 'prompt_tokens_details': {'cached_tokens': 256}, 'prompt_cache_hit_tokens': 256, 'prompt_cache_miss_tokens': 2566}`

---

- 新增 `testToLocalDate` 测试方法，用于验证 `CalendarUtils.toLocalDate()` 方法。
- 新增 import：`java.time.LocalDate`、`java.time.Month`、`org.junitpioneer.jupiter.DefaultTimeZone`。
